...
# ---------------------------------------------------------------------------
# Vercel detection (single source of truth)
# ---------------------------------------------------------------------------
IS_VERCEL = bool(os.environ.get("VERCEL") or os.environ.get("NOW_REGION"))

# ---------------------------------------------------------------------------
# Writable directories (redirect to /tmp on Vercel, use PROJECT_ROOT locally)
# ---------------------------------------------------------------------------
_WRITABLE_BASE = Path("/tmp") if IS_VERCEL else PROJECT_ROOT
